...
const STACK: StackGroup[] = [
  {
    ...
    rows: [
      ...
      },
      {
        name: "SWR",
        version: v("swr"),
        what: "Client-side data fetching with revalidation.",
        how: "Live unread badges and toasts — the sidebar counts refresh on navigation and on a `refreshBadges` event instead of being frozen into the server layout.",
      },
      {
        name: "lucide-react · clsx · CVA · tailwind-merge · date-fns",
        version: "—",
        what: "Icons and small utilities.",
        how: "Consistent iconography, conditional class composition, and date arithmetic for deadline clocks.",
      },
    ],
  },
  {
