...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/sites", label: "Sites", icon: "map-pin", capability: "site.manage" },
  { href: "/visits", label: "Visit Schedule", icon: "calendar", capability: "crf.enter" },
  { href: "/doctor-note", label: "Doctor Note", icon: "scan", capability: "crf.enter" },
  ...
  { href: "/copilot", label: "AI Copilot", icon: "bot", capability: "copilot.use" },
  { href: "/documents", label: "Documents", icon: "file-text", capability: "document.upload" },
  { href: "/exports", label: "Exports", icon: "download", capability: "export.run" },
