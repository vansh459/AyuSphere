...
export function AssistantPanel({
  ...
  return (
    <aside className="flex w-full flex-col overflow-hidden rounded-2xl bg-primary-deep xl:w-80 xl:shrink-0">
      ...
      <div className="flex flex-1 flex-col gap-4 rounded-t-2xl bg-surface p-4">
        {/* tabs */}
